 ...
 * @author Jose
 */
public class InstFutbolista extends javax.swing.JDialog {

    /**
     * Creates new form InstFutbolista
     */
    public InstFutbolista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstFutbolista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InstFutbolista dialog = new InstFutbolista(new javax.swing.JFrame(), true);
